...
// const contractAddress = process.env.REACT_APP_CONRACT_ADDRESS_IN_SEPOLIA;
// const contractAddress = process.env.CONRACT_ADDRESS_IN_SEPOLIA;
const contractAddress = import.meta.env.VITE_REACT_APP_CONTRACT_ADDRESS_IN_SEPOLIA;
// const contractAddress = "0xCcB7c237977B4c5A5571C3935fe41D7499d6CCFE"
...
export async function registerCrate(crate) {
  ...
  const receipt = await contract.methods.registerCrate(
    crate.crateCode,
    crate.batchId,
    crate.medicineId,
    crate.medicineName,
  ...
  const event = receipt.events?.CrateRegistered?.returnValues;
